...
public class ApsSettingsFragment extends PreferenceFragment {

    private static final boolean ALWAYS_SIMPLE_PREFS = false;

    public static final String DISPLAY_NAME = "display_name";
    public static final String FRIENDS_MESSAGES = "friends_messages";
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference(FRIENDS_MESSAGES));
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), ApsSettingsFragment.class));
                return true;
            }
